            ...
            <View style={styles.container}>
                <View style={styles.content}>
                    ...
                    <Button style={{ backgroundColor: Colors.rose }} onPress={onPressed}>
                        <GilroyRegular >Accedi</GilroyRegular>
                    </Button>
                    <GilroyBold style={{ alignSelf: 'center', marginVertical: 10 }}>oppure</GilroyBold>
                    <Button style={{ marginBottom: 20 }} onPress={onPressed}>
                        <GilroyRegular >Crea un nuovo account</GilroyRegular>
                    </Button>
                    <GilroyRegular style={{ marginHorizontal: 40, color: Colors.grey, textAlign: "center" }}>Continuando, accetti ai nostri <GilroyRegular style={{ color: Colors.grey }}>Termini del Servizo e Privacy Policy</GilroyRegular></GilroyRegular>
                </View>
            </View>
        </SafeAreaView>
    )
